...
(* OASIS_START *)
(* DO NOT EDIT (digest: 46ee8cf476136c4ee62927ccdb660900) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lisl"])];
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["IslMemory"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "Isl";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "ocaml-isl"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "setops.ml"});
               Test
                 ({
                     cs_name = "Set operations";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      test_working_directory = Some "/tmp";
                      test_run =
                        [
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\225\178X{\159k0W\1967b?\174\208:\241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
